...
import { FaUsers, FaCalendarAlt, FaBookOpen, FaLeaf, FaLightbulb, FaHandsHelping } from "react-icons/fa";
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative group overflow-hidden rounded-2xl bg-white dark:bg-slate-800 p-5 md:p-8 shadow-md hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 
    max-w-sm w-full mx-aut"
            >
              {/* Gradient background effect - now green */}
              ...
              {/* Icon container with green hover */}
              <motion.div 
              ...
              <h3 className="text-2xl font-bold mb-4 text-center text-slate-800 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">
                {item.title}
              </h3>
        ...
        {/* Modern decorative element - green */}
